/**
 * Painel flutuante (usado em todas as páginas públicas, no lugar da
 * antiga barra superior/inferior). Dá pra arrastar pelo cabeçalho e
 * minimizar/expandir clicando no botão — a posição e o estado
 * minimizado ficam salvos no navegador (localStorage), então
